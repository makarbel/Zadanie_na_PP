...
# Абсолютный путь к папке с изображениями — не зависит от рабочей директории запуска
...
class ChallengeCaptchaWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.image_paths = [os.path.join(IMAGES_DIR, f"{i}.png") for i in range(1, 5)]
        ...
        if self.first_selected_idx is None:
            ...
            if self.is_correct():
                for btn in self.buttons:
                    btn.setStyleSheet("border: 3px solid #2ecc71;")
